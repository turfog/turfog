      ...
      <AnimatePresence>
        {item.badge && item.badge > 0 && (
          <motion.span
            ...
            exit={{ scale: 0 }}
            className={cn(
              "ml-auto min-w-[20px] h-5 flex items-center justify-center rounded-full text-caption font-bold px-1.5",
              isActive
